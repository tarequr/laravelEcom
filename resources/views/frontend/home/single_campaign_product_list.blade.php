            ...
            <div class="col-lg-4 order-3">
                <div class="product_description">
                    ...
                    <div>
						...
						<div class="product_price" style="margin-top: 20px !important;">{{$setting->currency}}{{$campaignProduct->price}}</div>
                        {{-- @else
                    ...
                    <div class="order_info d-flex flex-row">
                        <form action="{{ route('add.to.cart.quickview') }}" method="POST" id="add_to_cart_form">
                            ...
                            <input type="hidden" name="price" value="{{ $campaignProduct->price }}">
                            ...
                            <div class="clearfix" style="z-index: 1000;">
                                ...
                                <div class="product_quantity clearfix ml-2">
                                    <span>Quantity: </span>
                                    <input id="quantity_input" type="text" name="qty" pattern="[1-9]*" value="1" min="1" max="10">
            ...
            <div class="col">
                ...
                <div class="viewed_slider_container">
                    ...
                    <div class="owl-carousel owl-theme viewed_slider">
                        ...
                        @foreach ($related_products as $reladed_pdt)
                        <div class="owl-item">
                            <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                <div class="viewed_image"><img src="{{ asset('upload/product/'.$reladed_pdt->product->thumbnail) }}" alt=""></div>
                                <div class="viewed_content text-center">
                                    <div class="viewed_price">{{$setting->currency}}{{$reladed_pdt->price}}</div>

                                    <div class="viewed_name"><a href="{{ route('single.campaign.product',$reladed_pdt->product->slug) }}">{{ substr($reladed_pdt->product->name,'0','50') }}</a></div>
                                </div>
                                <ul class="item_marks">
